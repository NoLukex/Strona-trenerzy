...
const profile: TrainerProfile = {
  ...
  city: 'Bydgoszcz',
  address: 'Nowotoruńska 12A, 85-840 Bydgoszcz, Polska',
  category: 'Trener osobisty',
  phone: '+48 789 433 410',
  email: 'kontakt@patrykmichalek.pl',
  website: 'http://patrykmichalek.pl/',
  instagram: 'https://www.instagram.com/patrysztos',
  facebook: '',
  rating: 5.0,
  heroTitleTop: 'TRENUJ',
