...
const profile: TrainerProfile = {
  ...
  city: 'Bydgoszcz',
  address: 'Królowej Jadwigi 23, 85-231 Bydgoszcz, Polska',
  category: 'Trener osobisty',
  phone: '+48 516 611 578',
  email: 'kontakt@bartoszjaszczak.pl',
  website: 'https://bartoszjaszczak.pl/',
  instagram: 'https://www.instagram.com/bartosz_jaszczak; http://instagram.com/bartosz_jaszczak',
  facebook: 'https://www.facebook.com/bartek.jaszczak',
  rating: 5.0,
  heroTitleTop: 'TRENUJ',
