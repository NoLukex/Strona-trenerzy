...
const profile: TrainerProfile = {
  ...
  phone: '+48 661 472 979',
  email: '%20stypczynsky@o2.p',
  website: 'https://silakonsekwencji.pl/',
  instagram: 'https://www.instagram.com/stypczynsky',
  facebook: 'https://www.facebook.com/stypczynsky',
  rating: 5.0,
  heroTitleTop: 'TRENUJ',
