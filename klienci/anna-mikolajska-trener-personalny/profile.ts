...
const profile: TrainerProfile = {
  ...
  city: 'Bydgoszcz',
  address: 'Bydgoskiego Batalionu Obrony Narodowej 4, 85-825 Bydgoszcz, Polska',
  category: 'Trener personalny kobiet',
  phone: '+48 694 395 011',
  email: '',
  website: 'https://www.instagram.com/ania.od.rozciagania?igsh=MTg1Mm84MXl0ejd2dA==',
  instagram: '',
  facebook: '',
  rating: 5.0,
