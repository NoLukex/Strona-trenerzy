...
const profile: TrainerProfile = {
  ...
  phone: '+48 533 700 341',
  email: '',
  website: 'https://radoslawhabera.pl/',
  instagram: 'https://www.instagram.com/radek_habera',
  facebook: 'https://www.facebook.com/trenerpersonalnyradekhabera',
  rating: 5.0,
  heroTitleTop: 'TRENUJ',
