...
const profile: TrainerProfile = {
  slug: 'kaja-narkun',
  fullName: 'Kaja Narkun',
  brandName: 'Kaja Narkun',
  navName: 'Kaja Narkun',
  brandTagline: 'Trener osobisty',
  city: 'Bydgoszcz',
  address: 'Rynkowska 2, Bydgoszcz, PL',
  category: 'Trener osobisty',
  phone: '+48 668 820 652',
  email: '',
  website: '',
  instagram: '',
  facebook: '',
  ...
  aboutHeading: 'Kaja Narkun - profesjonalne prowadzenie treningowe w Bydgoszczy.',
