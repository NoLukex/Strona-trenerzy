...
const profile: TrainerProfile = {
  ...
  city: 'Bydgoszcz',
  address: 'Jagiellońska 70A, 85-027 Bydgoszcz, Polska',
  category: 'Trener osobisty',
  phone: '+48 503 608 491',
  email: 'kontakt@bartosztrzebiatowski.pl',
  website: 'https://www.bartosztrzebiatowski.pl/',
  instagram: 'https://www.instagram.com/bartosztrzebiatowski_ig',
  facebook: 'https://www.facebook.com/bartosztrzebiatowski.fb',
  rating: 4.8,
  heroTitleTop: 'TRENUJ',
